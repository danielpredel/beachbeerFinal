        ...
        if ($conexion->connect_errno){
            ...
            if ($resultado -> num_rows){ //si la consulta genera registros
                ...
                while( $fila = $resultado -> fetch_assoc()){ //recorremos los registros obtenidos de la tabla
                    ...
                    //Modal
                    echo '<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal' .$fila['idProducto'] .'">Editar</button>';
                    ...
                    echo '<h1 class="modal-title fs-5" id="exampleModalLabel">Editar Producto</h1>';
                    echo '<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>';
                    echo '</div>';
                    echo '<div class="modal-body">¿Deseas editar la informacion de este producto?</div>';
                    echo '<div class="modal-footer">';
                    echo '<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>';
                    echo '<form action="editarProductosFormulario.php" method="post">';
